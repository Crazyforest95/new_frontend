              ...
              <tbody>
                ...
                {this.state.showSalery ?
                  <tr>
                    ...
                    {selectedResumes.map((resume, idx) => <td key={idx}>{resumes[resume.id].salery === "None" ? '' : resumes[resume.id].salery}</td>)}
                  </tr>
                  : <></>
                }
                ...
                {this.state.showEducation ?
                  <tr>
                    <td>学历</td>
                    {selectedResumes.map((resume, idx) => <td key={idx}>{resumes[resume.id].education === "None" ? "" : resumes[resume.id].education}</td>)}
                  </tr>
                  :
                  <></>
                }
