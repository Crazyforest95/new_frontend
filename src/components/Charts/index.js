...
const ResumeCollectionBarChart = getComponent(React.lazy(() => import('./ResumeCollectionBarChart')));
const StatisticsBarChart = getComponent(React.lazy(() => import('./StatisticsBarChart')));
